...
█═══════════════════════════════════════█
█ [${blanco}69${verde}] ┃ ${blanco}TermuxBlack          ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}70${verde}] ┃ ${blanco}trape                ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}71${verde}] ┃ ${blanco}UrlWeb               ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}72${verde}] ┃ ${blanco}ssh-honeypot         ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}73${verde}] ┃ ${blanco}pdfcrack             ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}74${verde}] ┃ ${blanco}lemon                ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}75${verde}] ┃ ${blanco}apkmod               ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}76${verde}] ┃ ${blanco}koroni               ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}77${verde}] ┃ ${blanco}msfpc                ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
█ [${blanco}78${verde}] ┃ ${blanco}apkmod2              ${verde}┃ ${blanco}NO ROOT ${verde}█
█═══════════════════════════════════════█
